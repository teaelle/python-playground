...
def main():
    ...
    earliestFileCreationDateToReview = '2017-01-01' # TESTING DATE RANGE
    latestFileCreateDateToReview = '2019-11-30'
    # latestFileCreateDateToReview = str(datetime.today())

    # Initialize Variables
    clientFileFound = 0
    clientCodeList = ['AGIL',' BAYR',' CMSE',' DISN',' FDMC',' FFMR',' FMAC',' GEND',' NEXT',' NLSN',' NOGU',' PEPS',' TEXI']
    dateOfFileCreation = ''
    sizeOfFile = 0
            ...
            try:
                with open(loaderFile, 'r', newline='') as csv_file:
                    ...
                    for line in csv_reader:
                        error = line[-2]
                        # print(error)
                        if 'hraAllocationScheduleEndDate' not in error: 
                            continue
