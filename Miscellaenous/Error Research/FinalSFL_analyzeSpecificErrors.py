...
def fileReportingReview():
    ...
    latestFileCreateDateToReview = '2019-11-30' # TESTING DATE RANGE
            ...
            try: # find test C error
                with open(loaderFile, 'r', newline='') as csv_file:
                    ...
                    for line in csv_reader:
                        ...
                        if "TooManyIndicativeChanges:" in line[-1]:
                            countOfParticipantsWithError += 1
                            errorOnRecord = True
                        # if "FieldCannotBeUpdatedOnceSet:dependentGenderCode" in line[-1]:
                        #     countOfParticipantsWithError += 1
                        #     errorOnRecord = True
                        if errorOnRecord:
                ...
                print(str(datetime.today())[11:19],'Review previous manually. Continuing review..')
                # continue
                # Reset the Counting Variables for Next File Review Loop
                countOfRecordsWithError = 0
                countOfParticipantsWithError = 0
