...
def fileReportingReview():
    ...
    # notImportedFilesLocation = '\\\\prodjobdata.extendhealth.com\\EligibilityFileImportNotImported' # FILE LOCATION
    # notImportedFilesLocation = '\\\\prodjobdata.extendhealth.com\\EligibilityFileImportNotImported\\2019\\8' # FILE LOCATION
    notImportedFilesLocation = '\\\\prodjobdata.extendhealth.com\\EligibilityFileImportNotImported\\2019' # FILE LOCATION
    ...
    latestFileCreateDateToReview = '2019-08-31' # TESTING DATE RANGE
    # latestFileCreateDateToReview = str(date.today() - timedelta(days=1)) # YESTERDAY
    ...
    print(str(datetime.today())[11:19],'Reviewing Files... ')
    ...
    for path, subdir, files in os.walk(notImportedFilesLocation):
        for file in files:
            ...
            try: # find test C error
                ...
                print('issue file status: saved-',fileDataSaved, ' count - ',countOfTotalRecords)
                # continue
                # Reset the Counting Variables for Next File Review Loop
                countOfRecordsWithError = 0
                countOfParticipantsWithError = 0
    ...
    # print("Results:") # DEBUG
    print(str(datetime.today())[11:19],'Review Complete: Outputing Results File')
    # Output CSV File with Results 
    # Determine File Name
    username = os.getlogin()
    reportName = clientNameCode + "_SsnInUseReviewReport_" + str(datetime.today())[:19].replace(':','') + username + ".csv"
